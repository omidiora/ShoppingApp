...
//  ShoppingApp
//
//  Created by Omidiora Emmanuel on 06/08/2026.
//
    ...
    var emptyState : some View {
        VStack(spacing: 14){
            ...
            Image(systemName: "bag")
                ...
                .foregroundStyle(Color(red: 0.45, green: 0.52, blue: 0.52))
        ...
        VStack(spacing: 16){
            ...
            Button(action: {}, label: {
                Text("Checkout")
                    ...
                    .padding(.vertical, 16)
                    .background(RoundedRectangle(cornerRadius: 14, style: .continuous ).fill(Color(red:0.28 , green:0.48 , blue: 0.44)))
            })
        }.padding(.horizontal, 24)
        .padding(.top, 24)
        .padding(.bottom, 28)
...
struct CartItemRow : View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading){
            ...
            Text(item.product.price)
                ...
                .foregroundStyle(Color(red:0.440, green: 0.48 , blue: 0.46))
        }
        
        Spacer()
        
        HStack(spacing:12){
            quantityButon(icon: "minus"){
    ...
    func quantityButon(icon: String , action : @escaping()-> Void) -> some View {
...
#Preview {
    NavigationStack {
        CartView().environment(CartStore())
    }
}
